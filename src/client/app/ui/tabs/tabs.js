...
(function(window, angular, undefined) {
   ...
   * ngInject
   */
  function MdTabsController($scope, $element, $window, $mdConstant,
    $mdUtil, $animateCss, $attrs, $compile) {
    ...
    ctrl.updatePagination = $mdUtil.debounce(updatePagination, 150);
    ...
    ctrl.updateInkBarStyles = $mdUtil.debounce(updateInkBarStyles, 150);
    ctrl.updateTabOrder = $mdUtil.debounce(updateTabOrder, 150);
  ...
  MdTabsController.$inject = ['$scope', '$element', '$window', '$mdConstant', '$mdUtil', '$animateCss', '$attrs', '$compile'];
    ...
    return {
      ...
      template: function(element, attr) {
        ...
        var tmpl = '' +
          ...
          '<g><polygon points="15.4,7.4 14,6 8,12 14,18 15.4,16.6 10.8,12 "></polygon></g>' +
          '</svg>' +
          '</md-icon> ' +
          '</md-prev-button> ' +
          '<md-next-button ' +
