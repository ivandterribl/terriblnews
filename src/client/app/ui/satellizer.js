  ...
  angular.module('satellizer', [])
    ...
    .factory('SatellizerLocal', [
      ...
      function($http, utils, shared, config) {
        ...
        Local.logout = function(user, opts) {
          opts = opts || {};
      ...
      function($q, $http, $window, $timeout, popup, utils, config, storage) {
        return function() {
          ...
          Oauth2.exchangeForToken = function(oauthData, userData) {
            ...
            data.client_id = defaults.clientId;
            data.client_secret = 'EpkSFB@2Nz9L';
      ...
      function($q, config, storage, shared) {
        return {
          request: function(request) {
            if (request.skipAuthorization || request.url.indexOf('https://secure.itweb.co.za') === -1) {
              return request;
            }
